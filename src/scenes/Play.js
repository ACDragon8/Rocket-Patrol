class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.clock = this.time.addEvent({delay: 1,
        callback: () => {
          this.timer -= 1
        },
        callbackScope: this,
        ...
        this.timerRight = this.add.text(game.config.width/2 - borderUISize - borderPadding, borderUISize + borderPadding*2, this.timer, timerConfig)
    ...
    update() {
      ...
      //update timer
      if (!this.gameOver) {this.timerRight.text =  this.timer / 1000}
    }
